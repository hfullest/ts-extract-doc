...
export type AuxOptions<T = any> = Pick<
  PickTreeProps<T>,
  "keyPropName" | "isLeafPropName" | "childrenPropName"
>;
...
const isCheckDisabled = <T extends PickTreeNode = PickTreeNode>(node: T) => {
...
>(
  ...
  allTreeMap: Map<string, T> = new Map(),
