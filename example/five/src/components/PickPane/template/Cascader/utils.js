...
exports.wipeAuxiliary = exports.conductCheck = exports.flatTree = exports.buildTree = exports.buildLevelMap = exports.isCheckDisabled = exports.isLeafSymbol = exports.childrenSymbol = exports.keySymbol = exports.activeSymbol = exports.paginationSymbol = exports.positionSymol = exports.indexSymbol = exports.levelSymbol = exports.checkStatSymbol = exports.parentSymbol = void 0;
...
exports.activeSymbol = Symbol("active");
...
var isCheckDisabled = function (node) {
    var _a, _b;
    var _c = (_b = (_a = node[exports.activeSymbol]) === null || _a === void 0 ? void 0 : _a.call(node)) !== null && _b !== void 0 ? _b : node, disabled = _c.disabled, disableCheckbox = _c.disableCheckbox, checkable = _c.checkable;
...
var flatTree = function (treeData, initParent, allTreeMap, options) {
    ...
    var _a = options !== null && options !== void 0 ? options : {}, _b = _a.keyPropName, keyPropName = _b === void 0 ? "key" : _b, _c = _a.childrenPropName, childrenPropName = _c === void 0 ? "children" : _c, _d = _a.isLeafPropName, isLeafPropName = _d === void 0 ? "isLeaf" : _d, rules = _a.rules;
    var map = new Map();
    ...
    var traverse = function (treeData, parent, status, level, index) {
        ...
        var parentPosition = parent ? (_a = parent[exports.positionSymol]) !== null && _a !== void 0 ? _a : [] : [];
        var _loop_2 = function (node) {
            ...
            addAuxiliary(node, (_b = {},
                _b[exports.parentSymbol] = parent,
                _b[exports.checkStatSymbol] = status,
                _b[exports.levelSymbol] = level,
                _b[exports.indexSymbol] = parentIndex + index++,
                _b[exports.positionSymol] = parentPosition.concat(node),
                _b[exports.paginationSymbol] = null,
                _b[exports.keySymbol] = { name: keyPropName, value: key },
                _b[exports.childrenSymbol] = { name: childrenPropName, value: children },
                _b[exports.isLeafSymbol] = { name: isLeafPropName, value: isLeaf },
                _b[exports.activeSymbol] = function () {
                    var _a, _b, _c, _d, _e, _f;
                    return ({
                        disabled: (_a = node["disabled"]) !== null && _a !== void 0 ? _a : (_b = rules === null || rules === void 0 ? void 0 : rules.disabled) === null || _b === void 0 ? void 0 : _b.call(rules, node, new Map(allTreeMap)),
                        disableCheckbox: (_c = node["disableCheckbox"]) !== null && _c !== void 0 ? _c : (_d = rules === null || rules === void 0 ? void 0 : rules.disabledCheckbox) === null || _d === void 0 ? void 0 : _d.call(rules, node, new Map(allTreeMap)),
                        checkable: (_e = node["checkable"]) !== null && _e !== void 0 ? _e : (_f = rules === null || rules === void 0 ? void 0 : rules.checkable) === null || _f === void 0 ? void 0 : _f.call(rules, node, new Map(allTreeMap)),
                    });
                },
                _b));
            map.set(key, node);
...
var fillConductCheck = function (nodesMap, levelMap, maxLevel) {
    ...
    for (var level = 1; level <= maxLevel; level++) {
        ...
        for (var _i = 0, nodes_5 = nodes; _i < nodes_5.length; _i++) {
            var node = nodes_5[_i];
            if (checkedNodes.has(node[exports.keySymbol].value) && !(0, exports.isCheckDisabled)(node)) {
                (_b = node[exports.childrenSymbol].value) === null || _b === void 0 ? void 0 : _b.forEach(function (it) {
                    if ((0, exports.isCheckDisabled)(it))
                        return;
...
var cleanConductCheck = function (nodesMap, halfNodesMap, levelMap, maxLevel) {
    ...
    for (var level = 1; level <= maxLevel; level++) {
        ...
        for (var _i = 0, nodes_7 = nodes; _i < nodes_7.length; _i++) {
            ...
            if (!checkedNodes.has(key) &&
                ...
                !(0, exports.isCheckDisabled)(node)) {
                (_b = node[exports.childrenSymbol].value) === null || _b === void 0 ? void 0 : _b.forEach(function (it) {
                    if ((0, exports.isCheckDisabled)(it))
                        return;
    ...
    for (var level = maxLevel; level > 0; level--) {
        ...
        var _loop_4 = function (node) {
            ...
            if ((0, exports.isCheckDisabled)(parent_5)) {
                visitedKeys.add(parentKey);
                return "continue";
            }
